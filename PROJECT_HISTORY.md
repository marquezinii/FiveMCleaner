...
> Arquivo histórico derivado do antigo `PROJECT_STATE.md`. **Não é leitura obrigatória para tarefas normais.**
> Use apenas quando uma tarefa exigir reconstruir decisões, implementações ou validações passadas. O estado vigente e canônico está em `PROJECT_STATE.md`.
