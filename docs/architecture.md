...
como ações secundárias. Jogos abre um catálogo interno que hoje contém somente
FiveM sobre GTAV Legacy; o card leva ao hub dedicado, e o hub e o otimizador
especializado mantêm Jogos como a categoria ativa. Sistema apresenta internamente o diagnóstico de
