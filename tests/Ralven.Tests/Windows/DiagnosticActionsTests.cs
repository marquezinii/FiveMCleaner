...
public sealed class DiagnosticActionsTests
{
    ...
    public void NewDiagnosticActions_AreAlwaysOnReadOnlyAndNonCritical()
    {
        ...
        foreach (var id in ids)
        {
            ...
            Assert.Equal(Ralven.Contracts.ActionReversibility.ReadOnly, definition.Reversibility);
            Assert.Equal(Ralven.Contracts.ActionRisk.Informational, definition.Risk);
