...
- **09/09/2026 — `dev/proxima-versao` integrada:** build Release sem avisos e **1.432 testes .NET** aprovados na árvore combinada antes do último squash; testes específicos do gateway Ralven AI (**11**) e dashboard (**56**) também passaram. A validação final deve ser reexecutada na `dev` atual antes de publicação.
